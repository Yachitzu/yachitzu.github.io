...
const translations = {
    en: {
        title: "Hi, I'm Estefanía", description: "Back-End developer",
    ...
    es: {
        title: "Hola, soy Estefanía", description: "Desarrolladora Back-End",
        about: "Estudiante de Ingeniería en Software en busca de desafíos",
        contac: "Contáctame",
        slide: "desliza",
        home: "Inicio",
        sobre: "Acerca de mi",
...
window.addEventListener("DOMContentLoaded", () => {
    ...
    window.addEventListener("resize", () => {
        if (!languageMenu.classList.contains("hidden")) {
            console.log("Redimensionando, ocultando menú");
            languageMenu.classList.add("hidden");
        }
    });
